function tracksFinal = scriptTrackGeneralSpatialAverageNeutrophils(movieInfo, imSz, mD, avgSz)
...
%function name
costMatrices(1).funcName = 'costMatRandomDirectedSwitchingMotionLinkSpatialAverage';
...
parameters.maxSearchRadius = mD; %maximum allowed search radius. Again, if a feature's calculated search radius is larger than this maximum, it will be reduced to this maximum.
...
parameters.avgSz = avgSz; %[JM] 
parameters.imsz  = imSz;  %[JM]
...
%function name
costMatrices(2).funcName = 'costMatRandomDirectedSwitchingMotionCloseGapsSpatialAverage';
...
parameters.maxSearchRadius = mD; %maximum allowed search radius.
...
[tracksFinal,kalmanInfoLink,errFlag] = trackCloseGapsKalmanSparseSpatialAverage(movieInfo,...
